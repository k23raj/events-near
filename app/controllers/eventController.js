...
module.exports.create=(req,res)=>{
    const data=req.body
    const event=new Event({user:req.user._id,name:data.name,description:data.description,category:data.category,seatDetails:{seatCount:data.seatCount,tktPrice:data.tktPrice},location:{city:data.city,address:data.address},date:{startDate:data.startDate,endDate:data.endDate}})
    event.save()
